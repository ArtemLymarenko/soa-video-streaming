...
CREATE TABLE IF NOT EXISTS media_content_categories (
    media_content_id TEXT NOT NULL REFERENCES media_content(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_media_content_categories_media_id 
    ON media_content_categories(media_content_id);
CREATE INDEX IF NOT EXISTS idx_media_content_categories_category_id 
    ON media_content_categories(category_id);
