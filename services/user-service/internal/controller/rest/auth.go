...
func NewAuthController(authService *service.AuthService, cfg *config.AppConfig) *AuthController {
...
func (c *AuthController) SignUp(gc *gin.Context) {
...
func (c *AuthController) SignIn(gc *gin.Context) {
