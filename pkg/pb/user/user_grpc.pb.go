...
const (
	...
	UserService_GetUserCategories_FullMethodName = "/user.v1.UserService/GetUserCategories"
)
...
func (c *userServiceClient) GetUserCategories(ctx context.Context, in *GetUserCategoriesRequest, opts ...grpc.CallOption) (*GetUserCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserCategoriesResponse)
	err := c.cc.Invoke(ctx, UserService_GetUserCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GetUserCategories(context.Context, *GetUserCategoriesRequest) (*GetUserCategoriesResponse, error) {
...
func _UserService_GetUserCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUserCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetUserCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserCategories(ctx, req.(*GetUserCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetUserCategories_Handler,
		},
	},
