...
const file_user_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2c\n" +
	"\vUserService\x12T\n" +
	"\x0fGetUserInfoByID\x12\x1f.user.v1.GetUserInfoByIDRequest\x1a .user.v1.GetUserInfoByIDResponseB+Z)soa-video-streaming/pkg/pb/user/v1;userv1b\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	2, // 2: user.v1.UserService.GetUserInfoByID:output_type -> user.v1.GetUserInfoByIDResponse
